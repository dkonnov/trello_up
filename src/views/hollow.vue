      ...
      <div class="info info-horizontal" stype="padding: 0px 0 30px;">
        <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="1s">
          ...
          <div class="description">
            ...
            <p class="description">
              ...
              не нужна учетная запись в самом Trello.
            </p>
          </div>
        </div>
        ...
        <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="3s">
          ...
          <div class="description">
            ...
            <p class="description">
              Мы постарались сделать так, чтобы наш сервис открывался одинаково
              хорошо на всех устройствах! Как на больших мониторах, так и на
              маленьких смартфонах.
            </p>
          </div>
        </div>
        <br />
