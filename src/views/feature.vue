<template>
  ...
  >
    <div class="col-lg-5 col-md-8 ml-auto mr-auto">
      ...
      <div class="section-description">
        ...
        <h5 class="description">
          <i
            >Наша система идеально подходит для небольших команд или отделов. </i
          ><br /><br />
          ...
          специалисты работают в Trello.<br />Создание учетных записей для
          пользователей в самом Trello не трубуется.<br /><br />
        </h5>
        <br />
    ...
    <div
      class="col-lg-6 col-md-12 ml-auto"
      style="padding-left: 30px; padding-right: 30px;padding-bottom: 40px;"
    >
      <br />
      <center>
